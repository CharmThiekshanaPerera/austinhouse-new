            ...
            <section className="relative h-[60vh] min-h-[500px] w-full flex items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <p className="text-white/80 font-light text-lg max-w-2xl mx-auto">
                        Delicate care and specialized treatments provided in a completely private, comfortable setting.
                    </p>
                </motion.div>
            </section>
        ...
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="w-full lg:w-1/2 h-[500px] lg:h-auto min-h-[500px] relative">
            <iframe 
              ...
              frameBorder="0" 
              allow="accelerometer; autoplay; clipboard-write; encrypted-inQ" 
...
export default IntimateAreaServices;
