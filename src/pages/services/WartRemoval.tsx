...
const WartRemoval = () => {
    ...
    const pageServices = services.filter(s => s.category === "Wart Removal");
            ...
            <section className="relative h-[60vh] min-h-[500px] w-full flex items-center justify-center overflow-hidden">
                ...
                >
                    ...
                    <h1 className="font-display text-4xl md:text-5xl lg:text-7xl font-bold text-white mb-6 leading-tight">
                        Wart & Skin Tag<br />Removal
                    </h1>
                    <p className="text-white/80 font-light text-lg max-w-2xl mx-auto">
                        Safe, fast, and highly effective CO2 laser treatments for clear skin.
                    </p>
                </motion.div>
            </section>
