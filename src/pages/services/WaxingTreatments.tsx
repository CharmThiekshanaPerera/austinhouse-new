        ...
        <div className="min-h-screen bg-background font-body">
            ...
            <section className="relative h-[60vh] min-h-[500px] w-full flex items-center justify-center overflow-hidden">
                <div className="absolute inset-0 z-0">
                    ...
                    <img
                        src="https://images.unsplash.com/photo-1556228578-8d89b6acd8d3?auto=format&fit=crop&q=80"
                        alt="Waxing"
                ...
                >
                    ...
                    <p className="text-white/80 font-light text-lg max-w-2xl mx-auto">
                        Hygienic, virtually painless depilatory services using master-grade hard waxes.
                    </p>
                </motion.div>
            </section>
...
export default WaxingTreatments;
